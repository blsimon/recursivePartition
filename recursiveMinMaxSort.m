...
function [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveMinMaxSort(A,n,partitions,i,temp,index,constant,j)
j = j+1;

[p,g1,g2] = fiedlerMinMaxSort(A);
...
if sizepartition1 > n && sizepartition2 > n
    ...
    [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveMinMaxSort(g1,n,partitions,i,temp,index,constant,j);
   % [i,partitions,temp] = boolean(partitions,boolean1,boolean2,i,sizepartition1,sizepartition2,temp,n);
    [constant] = find(index(:,j+1)==0,1,'first');
    constant = constant-1;
    
    [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveMinMaxSort(g2,n,partitions,i,temp,index,constant,j);
