...
function [partitions,index] = recursiveMinCut(A,n)
...
[sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveMinCutSort(A,n,partitions,i,temp,index,constant,j);
