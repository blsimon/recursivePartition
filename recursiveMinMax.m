...
function [partitions,index] = recursiveMinMax(A,n)
...
[sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveMinMaxSort(A,n,partitions,i,temp,index,constant,j);
