...
function [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveBisectionSort(A,n,partitions,i,boolean1,boolean2,temp,index,constant,j)
j = j+1;
[p,p1,p2,g1,g2] = fiedlerBisectionSort(A);
...
if sizepartition1 > n && sizepartition2 > n;
    ...
    [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveBisectionSort(g1,n,partitions,i,boolean1,boolean2,temp,index,constant,j);
    %[i,partitions,temp] = boolean(partitions,boolean1,boolean2,i,sizepartition1,sizepartition2,temp,n);
    [constant] = find(index(:,j+1)==0,1,'first');
    constant = constant-1;;
    
    [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveBisectionSort(g2,n,partitions,i+1,boolean1,boolean2,temp,index,constant,j);
...
elseif sizepartition2 > n;
    ...
    boolean2 = 0;
    [i,partitions,temp] = boolean(partitions,boolean1,boolean2,i,sizepartition1,sizepartition2,temp,n);
    [sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveBisectionSort(g2,n,partitions,i,boolean1,boolean2,temp,index,constant,j);
else
    boolean1 = 1;
    boolean2 = 1;
    [i,partitions,temp] = boolean(partitions,boolean1,boolean2,i,sizepartition1,sizepartition2,temp,n);
