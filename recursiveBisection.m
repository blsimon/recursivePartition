...
function [partitions,index] = recursiveBisection(A,n)
...
constant = 0;
j = 1;
[sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveBisectionSort(A,n,partitions,i,boolean1,boolean2,temp,index,constant,j);
