...
function [partitions,index] = recursiveBCut(A,n)
...
[sizepartition1,sizepartition2,partitions,i,index,constant] = recursiveBSort(A,n,partitions,i,temp,index,constant,j);
